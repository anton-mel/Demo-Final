...
//    CGA console page (see link/shared.ld's PROVIDE(console = 0xB8000)).
//    For the curious, read more here: https://wiki.osdev.org/Text_UI.
...
//
//    Usage Example:
//    console_printf(cpos(23, 0), 0xC000, format_args!("{}", x))
