// hardware.rs (ported from kernel/k-hardware.c)
//
...
pub fn process_init(p: &mut Proc, flags: u32) {
...
// check_keyboard
//    Check for the user typing a control key. 'a', 'f', 'e', 't', '2',
//    'm', and 'c' cause a soft reboot where the kernel runs the
//    "allocator" (final-project sbrk-based version), "fork",
//    "forkexit", "test", "test2", "malloc", or "alloctests" program(s),
//    respectively. Control-C or 'q' exit the virtual machine. Returns
//    key typed or -1 for no key.

pub fn check_keyboard() -> i32 {
    let c = keyboard_readc();
    if c == 'a' as i32 || c == 'f' as i32 || c == 'e' as i32 || c == 't' as i32 || c == '2' as i32 || c == 'm' as i32 || c == 'c' as i32 {
