...
pub unsafe fn virtual_memory_map(pagetable: *mut X86_64Pagetable, mut va: u64, mut pa: u64, mut sz: u64, perm: i32) -> i32 {
...
pub unsafe fn virtual_memory_lookup(pagetable: *mut X86_64Pagetable, va: u64) -> VaMapping {
    let mut pt = pagetable;
